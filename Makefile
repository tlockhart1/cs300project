...
JC = javac
.SUFFIXES: .java .class
all: SystemVheader Trie PassageProcessor edu_cs300_MessageJNI.o libsystem5msg.so searchmanager 
SystemVheader:
...
edu_cs300_MessageJNI.o: 
	$(CC) -c -fPIC -I${JAVA_HOME}/include -I${JAVA_HOME}/include/linux system5_msg.c -o edu_cs300_MessageJNI.o
libsystem5msg.so: 
...
clean: 
	$(RM) -r *.exe *.o *.so edu/cs300/*.class CtCILibrary/*.class searchmanager
